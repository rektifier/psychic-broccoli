...
// parser.ts was split into focused modules (substitution.ts). These
// re-exports keep existing `from './parser'` imports working; a follow-up
// updates the importers and drops them.
